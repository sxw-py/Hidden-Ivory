                ...
                <div key={item.id} style={{ display: 'flex', gap: '1rem' }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <p style={{ fontFamily: '"Cormorant SC",serif', fontSize: '1.3rem', color: '#e5b876' }}>R{(p.price * item.quantity).toLocaleString('en-US')}</p>
                    </div>
                  </div>
                </div>
              );
        ...
        {items.length > 0 && (
          <div style={{ padding: '1.5rem', background: '#111111', borderTop: '1px solid rgba(229,184,118,0.1)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem', fontFamily: '"Cormorant SC",serif', fontSize: '1.4rem', color: '#ffffff' }}>
              <span>Subtotal</span>
              <span style={{ color: '#e5b876' }}>R{cartTotal.toLocaleString('en-US')}</span>
            </div>
